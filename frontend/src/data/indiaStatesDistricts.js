// Static India states/UTs -> districts list for the public KYC form's
// cascading State -> District pickers (pages/Payments/PublicKycForm.jsx).
// District boundaries/names change occasionally (new districts get carved
// out) — this is a best-effort, reasonably current list, not an official
// government feed. City stays free-text: there's no practical way to embed
// a complete district->city dataset for the whole country statically.
...
export const INDIA_DISTRICTS = {
  ...
  'Madhya Pradesh': [
    ...
    'Dindori', 'Guna', 'Gwalior', 'Harda', 'Narmadapuram', 'Indore', 'Jabalpur', 'Jhabua', 'Katni',
  ...
  Rajasthan: [
    ...
    'Rajsamand', 'Salumbar', 'Sanchore', 'Sawai Madhopur', 'Sikar', 'Sirohi', 'Tonk', 'Udaipur',
  ],
