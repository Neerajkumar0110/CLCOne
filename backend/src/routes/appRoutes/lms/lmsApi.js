...
const lms = require('../../../controllers/appControllers/lms/lmsController/index');
const { requireManager } = require('../../../controllers/appControllers/lms/lmsController/permissions');
