...
try {
  ...
  const models = {
    ...
    SalesCost: unwrap(require('../src/models/appModels/SalesCost')),
    MarketingMetric: unwrap(require('../src/models/appModels/MarketingMetric')),
    ...
    // LMS ⇄ Moodle integration (services/lms/, config/lms.js).
    MoodleUserMap: unwrap(require('../src/models/appModels/MoodleUserMap')),
    MoodleObjectMap: unwrap(require('../src/models/appModels/MoodleObjectMap')),
    LmsEnrolment: unwrap(require('../src/models/appModels/LmsEnrolment')),
    LmsWebhookEvent: unwrap(require('../src/models/appModels/LmsWebhookEvent')),
    LmsSyncJob: unwrap(require('../src/models/appModels/LmsSyncJob')),
    ...
    CourseModule: unwrap(require('../src/models/appModels/CourseModule')),
    Chapter: unwrap(require('../src/models/appModels/Chapter')),
    Lesson: unwrap(require('../src/models/appModels/Lesson')),
    LessonProgress: unwrap(require('../src/models/appModels/LessonProgress')),
    CourseProgress: unwrap(require('../src/models/appModels/CourseProgress')),
    Assignment: unwrap(require('../src/models/appModels/Assignment')),
    AssignmentSubmission: unwrap(require('../src/models/appModels/AssignmentSubmission')),
    Quiz: unwrap(require('../src/models/appModels/Quiz')),
    Question: unwrap(require('../src/models/appModels/Question')),
    QuizAttempt: unwrap(require('../src/models/appModels/QuizAttempt')),
    Doubt: unwrap(require('../src/models/appModels/Doubt')),
    LmsAnnouncement: unwrap(require('../src/models/appModels/LmsAnnouncement')),
    CertificateRule: unwrap(require('../src/models/appModels/CertificateRule')),
